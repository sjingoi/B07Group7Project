...
public class DummyOrder implements OrderInterface {
    ...
    public void getPendingOrdersForStoreOwner(String storeOwnerId, OrderCallback callback) {
        ...
        //products1.put(new Product("ProductA", "Description A", "10.99", "image_url_A", new Store("Store1", "Store1 UUID"), 5), 1);
        //products1.put(new Product("ProductB", "Description B", "5.99", "image_url_B", new Store("Store1", "Store1 UUID"), 3), 2);
        //Order order1 = new Order(products1, new Store("Store1", "Store1 UUID"), new Customer("Customer1", "Customer1 UUID"));
        //dummyOrders.add(order1);

        // Dummy Order 2
        //HashMap<Product, Integer> products2 = new HashMap<>();
        //products2.put(new Product("ProductC", "Description C", "7.99", "image_url_C", new Store("Store1", "Store1 UUID"), 2), 3);
        //Order order2 = new Order(products2, new Store("Store1", "Store1 UUID"), new Customer("Customer2", "Customer2 UUID"));
